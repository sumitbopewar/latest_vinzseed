                    ...
                    <div className='container-fluid'>
                        <div className='row'>
                            <div className='col-md-3 part1'>
                                ...
                                <p><LocationOnOutlinedIcon /> <strong>Address</strong>: Behind T B Hospital, Jaganath Budhwari, Maskasath, Itwari , Nagpur-440002</p>
                                <p><HeadphonesOutlinedIcon /> <strong>Call Us: 8177819117</strong> (+91) -  </p>
                                <p><EmailOutlinedIcon /> <strong>Email:</strong> info@vinzseeds.com</p>
                                ...
                                <div className='row'>
                                    <div className='col'>
                                        ...
                                        <ul class="footer-list mb-sm-5 mb-md-0">
                                            ...
                                            <li><Link to="#">Privacy Policy Conditions</Link></li>
                        ...
                        <div className='row lastStrip'>
                            <div className='col-md-3 part_1'>
                                <p>© 2024, ICEICO Technologies Pvt Ltd. 
